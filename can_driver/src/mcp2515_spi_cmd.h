...
#define SPICMD_READ_RX0_ID          ( 0x90U )           /* Read bytes from RX0 CAN id.        */
#define SPICMD_READ_RX0_CONTENT     ( 0x92U )           /* Read bytes from RX0 CAN content.   */
#define SPICMD_READ_RX1_ID          ( 0x94U )           /* Read bytes from RX1 CAN id.        */
#define SPICMD_READ_RX1_CONTENT     ( 0x96U )           /* Read bytes from RX1 CAN content.   */
